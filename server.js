...
wss.on('connection', (ws) => {
  ...
  try {
    ...
    dgWs.onopen = () => {
	  ...
	  // Configuration simplifiée pour Deepgram
	  ...
	  console.log('Configuration envoyée à Deepgram:', JSON.stringify(deepgramConfig));
	  dgWs.send(JSON.stringify(deepgramConfig));
	};
