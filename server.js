  ...
  function attemptReconnect() {
    ...
    setTimeout(() => {
      try {
        ...
        dgWs = new WebSocket(`wss://api.deepgram.com/v1/listen?model=${languageModel}&language=${language}&encoding=opus&sample_rate=48000&channels=1&interim_results=true`, {
